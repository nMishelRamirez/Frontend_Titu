...
import { RegisterFormComponent } from '../register-form/register-form.component';  // Importa el componente RegisterFormComponent aquí

@Component({
  selector: 'app-register',
  standalone: true,  // Asegúrate de que sea un componente independiente
  imports: [CommonModule, FormsModule, RegisterFormComponent],  // Importa CommonModule y FormsModule aqu
